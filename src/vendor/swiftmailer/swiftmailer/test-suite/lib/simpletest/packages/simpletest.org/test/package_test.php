...
class TestOfContentTransformationFromXMLToHTML extends UnitTestCase {
	...
	function testOfContentFromChangeLogSection() {
		...
		$this->assertPattern('/<li>\[bug <a href=\"http:\/\/sourceforge.net\/tracker\/index1.php\?func=detail&group_id=76550&atid=547455&aid=1853765\">1853765<\/a>\] Fixing one of the incompatible interface errors<\/li>/', $content);
	}
	...
	function testOfContentFromMilestoneSection() {
		...
		$this->assertPattern('/<dd>tracker : <a href=\"http:\/\/sourceforge.net\/tracker\/index1.php\?func=detail&group_id=76550&atid=547455&aid=1896582\">1896582<\/a><\/dd>/', $content);
