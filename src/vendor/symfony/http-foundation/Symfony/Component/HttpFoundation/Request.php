...
class Request
{
     ...
     *
     * Suppose that an index1.php file instantiates this request object:
     *
     *  * http://localhost/index1.php         returns an empty string
     *  * http://localhost/index1.php/page    returns an empty string
     *  * http://localhost/web/index1.php     returns '/web'
     *  * http://localhost/we%20b/index1.php  returns '/we%20b'
     *
     * @return string The raw path (i.e. not urldecoded)
     *
     * @api
     ...
     * script filename (e.g. index1.php) if one exists.
     *
