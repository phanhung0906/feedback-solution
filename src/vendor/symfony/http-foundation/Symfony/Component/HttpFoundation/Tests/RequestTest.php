...
class RequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetUri()
    {
        ...
        // http://host:8080/index1.php/path/info?query=string
        ...
        $server['REQUEST_URI'] = '/index1.php/path/info?query=string';
        $server['SCRIPT_NAME'] = '/index1.php';
        $server['PATH_INFO'] = '/path/info';
        $server['PATH_TRANSLATED'] = 'redirect:/index1.php/path/info';
        $server['PHP_SELF'] = '/index_dev.php/path/info';
        $server['SCRIPT_FILENAME'] = '/some/where/index1.php';

        $request = new Request();

        $request->initialize(array(), array(), array(), array(), array(), $server);

        $this->assertEquals('http://host:8080/index1.php/path/info?query=string', $request->getUri(), '->getUri() with non default port');
        ...
        $this->assertEquals('http://host/index1.php/path/info?query=string', $request->getUri(), '->getUri() with default port');
        ...
        $this->assertEquals('http://servername/index1.php/path/info?query=string', $request->getUri(), '->getUri() with default port without HOST_HEADER');

        // Request with URL REWRITING (hide index1.php)
        ...
        $server = array(
            ...
            'PATH_TRANSLATED' => 'redirect:/index1.php/foo bar/in+fo',
    ...
    public function testGetUriForPath()
    {
        ...
        $this->assertEquals('http://host:8080/index1.php/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with non default port');
        ...
        $this->assertEquals('http://host/index1.php/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with default port');
        ...
        $this->assertEquals('http://servername/index1.php/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with default port without HOST_HEADER');
    ...
    public function testGetScriptName()
    {
        ...
        $this->assertEquals('/index1.php', $request->getScriptName());
    ...
    public function testGetBasePath()
    {
        ...
        $server = array();
        $server['SCRIPT_FILENAME'] = '/some/where/index1.php';
        $server['ORIG_SCRIPT_NAME'] = '/index1.php';
        $request->initialize(array(), array(), array(), array(), array(), $server);
